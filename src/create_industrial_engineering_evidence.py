...
def write_evidence_markdown() -> None:
    ...
    rows = [
        ...
        "| Occurrence | `raw_probability` and `raw_probability >= 0.86` | Higher raw failure probability raises priority under the final app decision policy. |",
        ...
        "    72 x raw_probability",
        "  + 14 x I(raw_probability >= 0.86)",
        ...
        "| Term | Role |",
        "|---|---|",
        "| `raw_probability` | Main failure-risk signal used for the final app decision. |",
        "| `0.86` | Validation-selected raw-probability High Risk threshold. |",
