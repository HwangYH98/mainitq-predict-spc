...
[Setup]
AppId={{6C64B38B-9B55-49FA-9DAA-9CB7A3F9D955}
AppName={#MyAppName}
...
OutputDir=..\release
OutputBaseFilename=MaintiQ_Predict_Setup
Compression=lzma2
...
[Files]
Source: "..\dist\MaintiQ_Predict\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
